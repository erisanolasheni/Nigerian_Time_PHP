...
public function getMinute($minute)
{
	...
	if ($minute > 30) $description = YorubaConstants::BEFORE_POINTER . $this->getNumber(60 - $minute);
	elseif ($minute < 30) $description = YorubaConstants::AFTER_POINTER . $this->getNumber($minute);

	return $description;
}
public function getHour($hour)
{
	if ($hour > 12) return YorubaConstants::TIME_POINTER . $this->getNumber($hour-12);
	else return YorubaConstants::TIME_POINTER . $this->getNumber($hour);
	}
